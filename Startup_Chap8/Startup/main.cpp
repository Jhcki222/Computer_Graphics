...
int main(int, char**)
{
	...
	gMesh = import_mesh_obj("..\\Bunny_8327v.obj");
...
void ShowTestWindow(bool* p_open)
{
	...
	//ImGui::DragFloat3(u8"이동", T, 0.1f, -10.0f, 10.0f);
	//ImGui::DragFloat3(u8"회전", R, 0.1f, -180.0f, 180.0f);
	//ImGui::DragFloat3(u8"스케일", S, 0.1f, 0.0f, 10.0f);
	ImGui::ColorEdit3(u8"색상", gMesh->m_Color);
